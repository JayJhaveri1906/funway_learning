...
class AppTheme {
  ...
  static final TextStyle phonicSound1 = TextStyle(
    inherit: true,
    fontFamily: 'WorkSans-Regular.ttf',
    color: Colors.white
    ,
  ...
  static final TextStyle sampleWord1 = TextStyle(
    inherit: true,
    fontFamily: 'WorkSans-Regular.ttf',
    color: Colors.black,
    fontWeight: FontWeight.w500,
  ...
  static final TextStyle page_heading1 = TextStyle(
    fontFamily: 'Chewy',
    fontWeight: FontWeight.w900,
    fontSize: 25,
    color: Colors.white,
  ...
  static final TextStyle wordListHead = TextStyle(
    inherit: true,
    fontFamily: 'WorkSans-Regular.ttf',
    color: Colors.black,
    fontWeight: FontWeight.w500,
